  ...
  const imprimirCupom = () => {
    ...
    const conteudo = `
      ...
      <body>
        ...
        <div>Venda: #${ultimaVenda.numeroVenda}</div>
        ...
        <div>Forma: ${formaPagamento.replace('_', ' ').toUpperCase()}</div>
        ${ultimaVenda.valorPago ? `<div>Pago: ${formatarMoeda(ultimaVenda.valorPago)}</div>` : ''}
        ${ultimaVenda.troco ? `<div>Troco: ${formatarMoeda(ultimaVenda.troco)}</div>` : ''}
        <div class="line"></div>
        <div class="footer">
