...
interface OSDetailPageProps {
  os: OrdemServico & {
    cliente: Cliente & { cpf?: string | null; endereco?: string | null }
...
const imprimirOS = (os: OSDetailPageProps['os']) => {
  // Total inclui orçamento + serviço + peças
...
${os.loja.nome}`
  ...
  // Total inclui orçamento + serviço + peças
  const valorTotal = (parseFloat(orcamento) || 0) + (parseFloat(valorServico) || 0) + (parseFloat(valorPecas) || 0)
